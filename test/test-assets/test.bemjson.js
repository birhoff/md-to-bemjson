module.exports = {
    ...
    content: [{ block: 'heading', mods: { level: 1 }, content: 'BEMHTML: шаблонизатор для БЭМ' }, {
        block: 'paragraph',
        content: { href: 'https://youtu.be/1GWoMnYldYc', block: 'link', content: 'Youtube 1' }
    }, {
        block: 'paragraph',
        content: [{ block: 'strong', content: 'BEMHTML' },
            ' — шаблонизатор (шаблонный движок) для тех, кто ведет веб-разработку в рамках ',
            { href: 'https://ru.bem.info/method', block: 'link', content: 'БЭМ-методологии' },
            '.\nBEMHTML — это:']
    }, {
        block: 'list',
        mods: { type: 'ul' },
        content: [{
            block: 'list-item',
            content: { block: 'paragraph', content: 'HTML-верстка в терминах блоков, элементов, модификаторов;' }
        }, { block: 'list-item', content: { block: 'paragraph', content: 'поддержка CSS в стиле БЭМ;' } }]
